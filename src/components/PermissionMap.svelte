      ...
      <SideModal>
        <div bind:this={sideModal} slot="content" class="flex flex-col relative px-2 pb-10">
          ...
          <div class="flex flex-wrap mb-5 px-1">
            ...
            <input bind:value={startdaySelected} type="date" max={enddaySelected} class="h-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-32" />
            <input bind:value={enddaySelected} type="date" min={startdaySelected} class="h-10 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-32" />
